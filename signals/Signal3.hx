...
class Signal3<T1, T2, T3>{
  var l:Array<T1->T2->T3->Void>; // listeners
  var o:Array<T1->T2->T3->Void>; // once listeners
  ...
  public var activate:Signal3<T1, T2, T3>->Void;
  public var deactivate:Signal3<T1, T2, T3>->Void;

  public function new(?activate:Signal3<T1, T2, T3>->Void = null, ?deactivate:Signal3<T1, T2, T3>->Void = null){
  ...
  public function add(f:T1->T2->T3->Void, ?prioritize:Bool = false){
    if(prioritize)
      l.insert(0, f);
    else
      l[listeners] = f;
  ...
  public function once(f:T1->T2->T3->Void, ?prioritize:Bool = false){
    if(prioritize)
      o.insert(0, f);
    else
      o[listenersOnce] = f;
