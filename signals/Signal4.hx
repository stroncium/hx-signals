...
class Signal4<T1, T2, T3, T4>{
  var l:Array<T1->T2->T3->T4->Void>; // listeners
  var o:Array<T1->T2->T3->T4->Void>; // once listeners
  ...
  public var activate:Signal4<T1, T2, T3, T4>->Void;
  public var deactivate:Signal4<T1, T2, T3, T4>->Void;

  public function new(?activate:Signal4<T1, T2, T3, T4>->Void = null, ?deactivate:Signal4<T1, T2, T3, T4>->Void = null){
    this.activate = activate;
    this.deactivate = deactivate;
    l = new Array<T1->T2->T3->T4->Void>();
    o = new Array<T1->T2->T3->T4->Void>();
    listeners = 0;
    listenersOnce = 0;
    }

  public function add(f:T1->T2->T3->T4->Void, ?prioritize:Bool = false){
    if(prioritize)
      l.insert(0, f);
    else
      l[listeners] = f;
  ...
  public function once(f:T1->T2->T3->T4->Void, ?prioritize:Bool = false){
    if(prioritize)
      o.insert(0, f);
    else
      o[listenersOnce] = f;
    ...
    inline
  #end
  public function dispatch(a1:T1, a2:T2, a3:T3, a4:T4){
  ...
  public function remove(f:T1->T2->T3->T4->Void){ // removes first occurence in l
    var i = listeners;
